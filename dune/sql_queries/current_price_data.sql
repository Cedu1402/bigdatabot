  ...
  buy_volume AS (
    ...
    WHERE token_sold_mint_address = 'So11111111111111111111111111111111111111112' AND
          t.block_time BETWEEN tk.call_block_time AND tk.call_block_time + INTERVAL '{{min_token_age_h}}' hour
    GROUP BY
  ...
  sell_volume AS (
    ...
    WHERE token_bought_mint_address = 'So11111111111111111111111111111111111111112'
      AND t.block_time BETWEEN tk.call_block_time AND tk.call_block_time + INTERVAL '{{min_token_age_h}}' hour
    GROUP BY
