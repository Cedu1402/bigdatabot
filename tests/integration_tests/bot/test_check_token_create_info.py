...
class TestCheckTokenCreateInfo(unittest.IsolatedAsyncioTestCase):
    ...
    # Mock Redis Client
    @mock.patch('blockchain_token.token_creation.select_token_creation_info')
    async def test_check_token_create_info_found(self, mock_select_token_creation_info):
        ...
        # Call the function
        result = await check_token_create_info_age_now(token)
    ...
    @mock.patch('blockchain_token.token_creation.select_token_creation_info')
    @mock.patch('blockchain_token.token_creation.load_token_create_info', new_callable=mock.AsyncMock)
